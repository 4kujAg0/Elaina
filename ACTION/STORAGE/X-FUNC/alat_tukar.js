require("../../../ACTION/OPTIONS/settings.js")
    const fs = require('fs')  
  let _inventoryOrang = JSON.parse(fs.readFileSync('./ACTION/STORAGE/X-DATA/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./ACTION/STORAGE/X-DATA/inventory.json', JSON.stringify(_inventoryOrang))
   }
